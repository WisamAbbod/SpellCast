...
const InstructionsScreen = ({ navigation }) => (
  <View style={styles.instructionsContainer}>
    <StarField numStars={45} />
    <Text style={styles.menuTitle}>How to Play</Text>
    <Text style={styles.instructionsText}>
      🎯 Find words by swiping through connected letters{"\n"}
      ⏱️ You have 60 seconds to score as many points as possible{"\n"}
      📏 Words must be at least 3 letters long{"\n"}
      🎊 Longer words give massive bonus points{"\n"}
      🚫 Each word can only be used once{"\n"}
      ⏸️ Tap pause anytime to take a break
    </Text>
